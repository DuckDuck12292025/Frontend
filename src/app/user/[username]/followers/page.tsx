/**
 * 페이지: 팔로워 목록
 * 경로: /user/[username]/followers
 * 설명: 특정 사용자의 팔로워 목록을 표시하고, 각 팔로워에 대해
 *       팔로우/언팔로우 토글 기능을 제공하는 화면.
 *
 * 사용하는 API:
 *   - 없음 (현재 로컬 state로 처리)
 *
...
export default function FollowersPage() {
  ...
  const title = `${decodedUsername}님의 팔로워`;
  ...
  // Mock followers: all users except the first one
  const followers = mockUsers.slice(1);
      ...
      <div className="bg-white lg:border lg:border-neutral-200 lg:rounded-xl">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-neutral-400 text-sm">팔로워가 없습니다</p>
          </div>
        ) : (
          <div className="divide-y divide-neutral-100">
            {followers.map((u) => (
